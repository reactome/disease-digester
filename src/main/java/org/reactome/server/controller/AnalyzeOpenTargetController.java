...
public class AnalyzeOpenTargetController {
    ...
    public AnalyzeOpenTargetController(GeneAnalysisService geneAnalysisService) {
    ...
    AnalysisResult diseaseAnalysis(@Parameter(name = "disease", description = "A specific disease, identified by disease id.", required = true, example = "C4279912") @PathVariable(value = "disease") String disease,
        ...
        return geneAnalysisService.analysisByDisease(disease, projection, interactors, SortBy.ENTITIES_PVALUE, OrderBy.ASC, Resource.TOTAL, pValue, includeDiseasePathways, SourceDatabase.OPEN_TARGET, UrlUtil.getBaseUrl(request));
    }
}