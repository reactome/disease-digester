        ...
        <div id="r-notresponsive-table" class="details-wrap enlarge-table">
            <table class="reactome table-parameter">
                ...
                <tr>
                    ...
                    <td data-label="Description">Average l2g score provided by OpenTarget.
                    </td>
                </tr>
                <tr>
...
<footer>
    <script src="/overlays/resources/js/vue.js?v=0.1"></script>
    <script src="/overlays/resources/js/axios.js?v=0.1"></script>
    <script type="module" src="/overlays/resources/js/overlay-open-target.js?v=0.1"></script>
</footer>
